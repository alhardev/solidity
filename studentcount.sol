...
mapping(uint => StudentDataCentre) public studentData;

uint public studentCount;

    function setStudentDataCentre(string memory _name, string memory _homeAddress, string memory _course, uint _age, bool _hasGraduated)

    public {

        studentCount++;

        studentData[studentCount] = StudentDataCentre(studentCount,_name,_homeAddress,_course,_age,_hasGraduated);
    }
